...
ROLE_DEFAULT_PAGES = {
    "operator": ["dashboard"],
    "media_admin": ["dashboard", "atms", "upload", "packages", "agent-updates", "reports", "logs", "journal"],
    "cash_monitoring_viewer": ["dashboard", "cash", "reports"],
    "cash_monitoring_admin": ["dashboard", "cash", "reports", "notifications", "atms", "logs", "journal"],
}
